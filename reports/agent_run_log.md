...
- 실행 ID: `run-20260812T145853Z`
- 시작: `2026-08-12T14:58:53.796475+00:00`
- 종료: `2026-08-12T14:59:36.456457+00:00`
- 총 실행 시간: 42.66초
- 외부 LLM API: 사용하지 않음
...
- 명령: `C:\Users\bobgy\AppData\Local\Microsoft\WindowsApps\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\python.exe -B src/scanner.py`
...
- 실행 방식: `deterministic_local_program_no_llm_api`
- 명령: `C:\Users\bobgy\AppData\Local\Microsoft\WindowsApps\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\python.exe -B src/context_builder.py`
...
- 실행 방식: `deterministic_local_program_no_llm_api`
- 명령: `C:\Users\bobgy\AppData\Local\Microsoft\WindowsApps\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\python.exe -B src/analyze_candidates.py`
